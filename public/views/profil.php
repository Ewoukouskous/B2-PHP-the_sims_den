...
<body class="h-screen overflow-hidden">
    ...
    <div id="content" class="relative flex justify-center h-screen overflow-hidden p-4 pt-12">
        ...
        <div class="absolute top-36 w-full max-w-7xl px-4">
            ...
            <div class="bg-[#F0EEE9] bg-opacity-90 rounded-[1.8rem] shadow-[0px_8px_0px_0px_rgba(51,184,66,0.9)] p-6 flex flex-col gap-4">
                ...
                <div class="grid grid-cols-[1fr_auto_1fr] gap-6 items-start">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            <?php for ($i = 0; $i < 10; $i++): ?>
                                <div class="w-12 h-12 rounded-full bg-[#3769a9] bg-opacity-20 border-2 border-[#3769a9] border-opacity-20 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-[#3769a9] opacity-30" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <div class="w-20 h-20 rounded-full bg-[#2a5885] border-4 border-[#33b842] overflow-hidden flex items-center justify-center shadow-lg">
                        ...
                        <span class="text-2xl font-bold text-[#3769a9]"><?php echo htmlspecialchars($username); ?></span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 min-h-[14rem]">
                        <?php foreach ($favoriteGames as $favorite): ?>
                            <div class="group relative bg-white rounded-[1.5rem] p-2.5 shadow-[0px_4px_0px_0px_rgba(51,184,66,0.9)] hover:-translate-y-1 transition-transform duration-200 cursor-pointer flex flex-col gap-2 h-[14rem]">
                                ...
                                <div class="px-2 py-0.5 bg-[#F0EEE9] rounded-full shadow-[0px_1px_0px_1px_rgba(158,158,158,1)] text-[#3769a9] font-medium text-sm text-center truncate">
                                    <?php echo htmlspecialchars($favorite['title']); ?>
                                </div>

                                <div class="flex items-center justify-between px-1">
                                    <span class="bg-[#33b842] text-white text-[9px] font-bold px-2.5 py-1 rounded-full shadow-[0px_1px_0px_1px_rgba(0,0,0,0.08)] border border-white/20 whitespace-nowrap">
                                        <?php echo htmlspecialchars($favorite['type']); ?>
                                    </span>
                                    <div class="flex items-center gap-2">
                                        <div class="bg-[#F0EEE9] px-2 py-0.5 rounded-full shadow-[0px_1px_0px_1px_rgba(158,158,158,1)] text-[#3769a9] font-bold text-xs">
                                            <?php echo htmlspecialchars($favorite['price']); ?>
                                        </div>
                                        <div class="flex items-center gap-0.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-red-400" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                                            </svg>
                                            <span class="text-[9px] font-bold text-[#3769a9]"><?php echo $favorite['favorites']; ?></span>
                                        </div>
                                    </div>
                                </div>
