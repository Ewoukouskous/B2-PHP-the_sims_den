            ...
            <div class="space-y-3 pb-12">
                ...
                <?php foreach ($favoriteGames as $favorite): ?>
                    <a href="game.php?id=<?php echo (int) $favorite['id']; ?>" class="block">
                        <?php if ($isConnected): ?>
                            <form id="favorite-form-<?php echo (int) $favorite['id']; ?>" method="post"
                                action="../actions/favorite.php" class="hidden">
                        ...
                        <section
                            class="bg-[#F0EEE9] bg-opacity-90 rounded-[1.8rem] shadow-[0px_8px_0px_0px_rgba(51,184,66,0.9)] p-2.5 md:p-3 hover:-translate-y-0.5 transition-transform duration-200">
                                ...
                                <div class="flex flex-col justify-center items-center gap-2.5 lg:pr-1">
                                    <button type="button"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M12 21s-6.716-4.437-9.428-8.13A5.727 5.727 0 0 1 12 6.422a5.727 5.727 0 0 1 9.428 6.448C18.716 16.563 12 21 12 21z" />
                                        </svg>
                                    </button>

                                    <div
                                        class="w-full bg-[#F0EEE9] rounded-4xl shadow-[0px_2px_0px_1.5px_rgba(158,158,158,1)] px-3 py-1.5 text-center text-[#3769a9] text-2xl font-medium whitespace-nowrap">
